...
---Unfocused window border color, as a hex string ("#RRGGBB" or "#RRGGBBAA").
---@field border_unfocused string
---Focused window border color, as a hex string.
---@field border_focused string
---Urgent window border color, as a hex string.
---@field border_urgent string
---Desktop background color, as a hex string.
---@field bg string
---Background color behind fullscreen windows, as a hex string.
